...
(function (global) {
  ...
  var api = {
    ...
    admin: {
      ...
      stations: function () { return api.get('/api/admin/stations'); },
      createStation: function (s) { return api.post('/api/admin/stations', s); },
      updateStation: function (id, s) { return api.patch('/api/admin/stations/' + id, s); },
      deleteStation: function (id) { return api.del('/api/admin/stations/' + id); },
